 ...
 * @author ADMIN
 */
public class MessageNotify extends javax.swing.JComponent {
    ...
    public MessageNotify(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/MessageDialog/Image/sucess.png")));
            lbMessage.setText("Success");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/MessageDialog/Image/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/MessageDialog/Image/warning.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/MessageDialog/Image/sucess.png"))); // NOI18N
        ...
        lbMessageText.setText("sfasdasdasdasdasdasdasdadadasdasdasdasdasd");
        ...
        panelLayout.setVerticalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addComponent(lbMessageText, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void createImageShadow() {
        ...
        g2.drawImage(createShadow(),0,0, this);
        g2.dispose();
    }
